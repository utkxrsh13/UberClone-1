  ...
  return (
    <div>
      ...
      <div
        ...
        className="border-2 active:border-black bg-gray-200 rounded-xl p-2 w-full mb-2 flex items-center justify-between"
      >
        <img
          className="h-12"
      ...
      <div
        onClick={props.setConfirmRidePanel(true)}
        className="border-2 active:border-black bg-gray-200 rounded-xl p-3 w-full mb-2 flex items-center justify-between"
      >
        <img
          className="h-12"
